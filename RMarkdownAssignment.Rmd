...
## My Semester
as.table(data)
# create matrix with 3 column
data= matrix(c(1:12), ncol=3 byrow=TRUE
# specify the column names and row names of matrix
colnames(data) = c(' __course number__ ', ' _course title_ ', ' instructor name ')
rownames(data) <- c('class one', 'class two' 'class three', 'class four')
# assign to table 
final= as.table(data)
#display
final
